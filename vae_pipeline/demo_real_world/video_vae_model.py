...
import sys 
sys.path.append("..") 
from utils.utils_vae import ConvUnit, ConvUnitTranspose, LinearUnit
...
class TemporalVAE(nn.Module):
	def __init__(self, e_dim=128, y_dim=128, conv_dim=512, step=128, in_size=64, nonlinearity=None):
		...
		self.mask = nn.Linear(self.y_dim, self.y_dim)
	...
	def forward(self, xt, xt_):
		...
		return et_mean, et_logvar, yt_, recon_xt_, self.mask.weight.detach().numpy()
