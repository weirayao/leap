...
import sys 
sys.path.append("..") 
from utils.utils_vae import SimulationDataset
...
vae_model = TemporalVAE(e_dim=2, y_dim=2, input_dim=2)
trainer = Trainer(vae_model, train_dataloader, test_dataloader, e_dim=2, epochs=30)
