...
from ltcl.datasets.kitti import KittiMasksPCL
from ltcl.baselines.PCL.model import PCLKitti
...
def main(args):
    ...
    data = KittiMasksPCL(path = os.path.join(cfg['ROOT'], cfg['DATASET']), 
